				...
				<div class="panel-heading" align="center">  <h3 >Nouvelle matière </h3>  </div>
					<div class="panel-body">
						<form method="post" action="insert_matiere.php">
							...
							<div class="row my-row">
								<input type="checkbox" name="choix[]" value="JAVA">JAVA <br>
								<input type="checkbox" name="choix[]" value="PHP">PHP <br>
								<input type="checkbox" name="choix[]" value="PYTHON"> PYTHONN <br>
								<input type="checkbox" name="choix[]" value="JEE"> JAVA EE
							</div>
						   <!-- ************ Fin  coeff: *************** -->
